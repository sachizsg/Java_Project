...
public class AddServices extends javax.swing.JDialog {
    ...
    public AddServices(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
       ...
       if(snametxt.getText().equalsIgnoreCase("") || spricetxt.getText().equalsIgnoreCase("")){
            ...
            if(valid.validatePrice(spricetxt.getText()) ){
                ...
                try{
                    int i = hs.addService();
                    if(i!=0){                       
                        JOptionPane.showMessageDialog(null, "Service has been added successfully.", "Message", JOptionPane.INFORMATION_MESSAGE);
                        this.dispose();
                    }
                    else{
                        JOptionPane.showMessageDialog(null, "Service cannot be add.", "Error", JOptionPane.ERROR_MESSAGE);
                        this.dispose();
                    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddServices dialog = new AddServices(new javax.swing.JFrame(), true);
